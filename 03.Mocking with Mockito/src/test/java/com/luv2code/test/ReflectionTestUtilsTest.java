...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach(){
        studentOne.setFirstname("Sameh");
        studentOne.setLastname("Tarek");
        studentOne.setEmailAddress("same@gmail.com");
    ...
    @Test
    public void invokedPrivateMethod() {
        assertEquals("Sameh 1",ReflectionTestUtils.
                invokeMethod(studentOne, "getFirstNameAndId"),
